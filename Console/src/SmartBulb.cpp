...
SmartBulb::SmartBulb(uint32_t i,string d,uint16_t x,uint16_t y,uint16_t lw,uint16_t r,float p,Color FC,Color LC,Color TC,bool s,uint16_t t) {
    index_ = i;
    designator_ = d;
    x_ = x;
    y_ = y;
